  ...
  const handleVerify = async () => {
    ...
    try {
      ...
      if (storedData) {
        ...
        setErrorMessage('Signup data not found.');
      }
    } catch (error) {
      console.error('Error during OTP verification or signup:', error);
      setErrorMessage('Error verifying OTP or signing up. Please try again.');
    } finally {
      setIsLoading(false);
    }
  };
  ...
  const handleResend = async () => {
    try {
      ...
      if (storedData) {
        ...
        setNotification({ type: 'error', message: 'Signup data not found.' });
      }
    } catch (error) {
